...
$caminho_absoluto = "../photos-contacts";
...
if(isset($_FILES['arquivo']['name'])):
    ...
    if(move_uploaded_file($arquivo_temporario,"$caminho_absoluto/$nome_arquivo_novo")):
        $sql = "UPDATE dbcontatos SET nomeFotoContato= '{$nome_arquivo_novo}' WHERE idContato = '{$idContato}'";
        mysqli_query($conect,$sql);
        echo "./pages/contacts/photos-contacts/{$nome_arquivo_novo};concluido";
    else:
